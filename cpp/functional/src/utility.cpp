...
std::vector<std::string> combine_subvectors(std::vector<std::string> sorted_left, std::vector<std::string> sorted_right, std::string pivot)
{
  std::vector<std::string> combo;

  combo.reserve(sorted_left.size() + sorted_right.size() + 1);
  combo.insert(combo.end(), sorted_left.begin(), sorted_left.end());
  combo.push_back(pivot);
  combo.insert(combo.end(), sorted_right.begin(), sorted_right.end());
